...
public class URINameSpaceEnglish {
	//Base Name Space
	...
	public static final String hasState = NS+"hasState";//Agent
	...
	public static final String idSensoreLocale = NS+"idMacAddress";
	...
	public static final String sensorType = NS+"sensorType";
